...
function getMalyshErrorReply(errText) {
    ...
    if (error.includes('429') || error.includes('quota') || error.includes('exhausted') || error.includes('лимит')) {
        const phrases = [
            "💸 Всё, ребят, лимиты всё. Мы слишком много болтаем, Админ перекрыл нам краник. Ждем отката квоты.",
    ...
    const phrases = [
        ...
        "💥 Я упал. Критическая ошибка! Поднимите кто-нибудь. И позовите админа, я работать не могу. Или не хочу)",
