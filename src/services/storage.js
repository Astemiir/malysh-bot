...
class StorageService {
  ...
  _getDefaultStats() {
    return {
      ...
      history: [],  // Архив дней: [{ date, smart, logic, search, voice, google }]
      allTime: {
        smart: 0,
        logic: 0,
        search: 0,
  ...
  _calcPeriodStats(days) {
    ...
    const result = { smart: 0, logic: 0, search: 0, voice: 0, google: 0 };
    ...
    result.voice += this.stats.today.voice;
  ...
  // Установить тему вручную (команда "Малыш, этот чат про...")
